...
class User(AbstractUser):
    sex = models.IntegerField(verbose_name="gender", choices=((0, 'male'), (1, 'female'), (2, 'non-binary')), default=2)
    image = models.ImageField(max_length=4096, upload_to='avatar', verbose_name=u'picture', null=True, blank=True)
